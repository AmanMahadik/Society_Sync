  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={styles.header}>
        <Text variant="headlineMedium" style={[styles.title, { color: theme.colors.error }]}>Emergency Alerts</Text>
        <Text variant="bodySmall" style={{ color: theme.colors.outline }}>
          Active crisis alerts in your housing complex
        </Text>
      </View>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <Card style={[
            styles.card,
            item.status === 'active' && { borderColor: theme.colors.error, borderWidth: 1 }
          ]}>
            <Card.Content style={styles.cardContent}>
              <View style={styles.cardHeader}>
                <View style={styles.cardHeaderLeft}>
                  <Avatar.Icon 
                    ...
                    color={item.status === 'active' ? theme.colors.error : '#888888'} 
                  />
                  <View>
                    ...
                    <Text variant="bodySmall" style={{ color: theme.colors.outline }}>
                      Flat: {item.wing}-{item.flat_number}
                    </Text>
                  </View>
                </View>
                <View style={[
                  ...
                  <Text style={[
                    styles.statusText,
                    { color: item.status === 'active' ? theme.colors.error : '#00D4AA' }
                  ]}>
                    {item.status}
                  </Text>
                </View>
              ...
              <Text variant="bodyMedium" style={styles.description}>
                Description: <Text style={{ color: '#FFFFFF' }}>{item.description || 'No comment provided.'}</Text>
              </Text>
